...
[[ -z ${SPARKJOB_DELAY_BASE+X} ]] && declare -i SPARKJOB_DELAY_BASE=15
export SPARKJOB_DELAY_BASE
[[ -z ${SPARKJOB_DELAY_MULT+X} ]] && declare SPARKJOB_DELAY_MULT=0.125
export SPARKJOB_DELAY_MULT
...
theta)
	...
	aprun -n 1 -N 1 \
		...
		-e SPARKJOB_DELAY_BASE=$SPARKJOB_DELAY_BASE \
